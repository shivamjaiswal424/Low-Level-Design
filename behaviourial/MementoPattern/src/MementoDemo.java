...
public class MementoDemo {
    public static void main(String[] args) {
        ...
        ApplicationConfiguration appConfig = new ApplicationConfiguration("Light", 12, true, "English");
        ...
        System.out.println("\n===> State 2: ");
        configurationManager.saveState(appConfig); // Creates amemento and stores it in history
        // State 3
        ...
        System.out.println("\n===> Undo 3: ");
        configurationManager.undo(appConfig); // Default St
    }
}